...
# ---------------------------------------------------------------------------
# --- Development library ----------------------------------------------------
$(LIB_DEV): src/hive.c src/hive_hpack.c $(COMPAT_SRC)
	@mkdir -p $(BUILD_DIR)
...
# --- Release library --------------------------------------------------------
$(LIB_REL): src/hive.c src/hive_hpack.c $(COMPAT_SRC)
...
$(LIB_VG): src/hive.c src/hive_hpack.c $(COMPAT_SRC)
...
# --- TSan library -----------------------------------------------------------
$(LIB_TSAN): src/hive.c src/hive_hpack.c $(COMPAT_SRC)
